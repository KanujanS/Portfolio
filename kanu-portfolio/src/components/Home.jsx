  ...
  return (
    <div className='flex mt-20'>
        <div>
            ...
            <p className='text-lg text-gray-400 py-5'>Enthusiastic and dedicated aspiring Software Engineer with a solid understanding of full-stack development.</p>
            <div className='text-white text-sm space-x-5'>
            ...
            <div className='flex gap-10 py-8 text-white text-sm'>
                ...
                <div className='flex items-center justify-center gap-2 rounded-xl px-7 py-3 bg-black/40' style={{ boxShadow: '0px 0px 20px rgba(14, 165, 233, 0.7)' }}>
                    <p>Contact Me</p>
                    <MdMailOutline className='text-lg'/>
                </div>
            </div>
            <div className='flex text-2xl text-gray-100/60 gap-10'>
